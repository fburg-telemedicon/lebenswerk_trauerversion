...
const PRECAUTION_RECORD_RULE = `ANGABEN ZURÜCKLESEN (verbindlich): Aus diesem Gespräch entsteht eine Urkunde. Jedes Mal, wenn ein NAME, ein DATUM, eine ANSCHRIFT, eine TELEFONNUMMER oder eine E-MAIL-ADRESSE genannt wird, liest du sie in deiner nächsten Nachricht wörtlich zurück und fragst in einem kurzen Satz, ob sie so richtig ist. Erst danach geht es weiter. NACH DER BUCHSTABIERUNG FRAGST DU NICHT VON SICH AUS — das macht das Gespräch zäh und behält niemand durch. Bitte nur dann darum, wenn es einen ANLASS gibt: wenn die Person deine Rückfrage verneint oder korrigiert, wenn sie selbst unsicher ist, oder wenn die Angabe erkennbar verstümmelt ist (abgebrochenes Wort, unmögliche Zeichenfolge, Zahlendreher). Korrigiert die Person, übernimmst du die Korrektur und liest sie erneut zurück. Rate NIEMALS eine Schreibweise, ergänze keine Postleitzahl und keinen Ortsteil, und vervollständige keine abgekürzte Angabe.`
