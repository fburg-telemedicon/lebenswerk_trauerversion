...
const DE = {
  ...
  relationshipHint: (name) => `Bitte aus Ihrer Sicht angeben: Wer sind Sie für ${name || 'diese Person'}? Gemeint ist Ihre eigene Rolle (z. B. Tochter, Freund, Kollegin) – nicht die Rolle von ${name || 'der Person'}.`,
...
const PL = {
  ...
  relationshipHint: (name) => `Podaj ze swojej perspektywy: kim jesteś dla osoby ${name || 'tej osoby'}? Chodzi o Twoją własną rolę (np. córka, przyjaciel, koleżanka) – nie o rolę osoby ${name || 'tej osoby'}.`,
...
const EN = {
  ...
  relationshipHint: (name) => `From your perspective: who are you to ${name || 'this person'}? This means your own role (e.g. daughter, friend, colleague) – not ${name || 'the person'}’s role.`,
