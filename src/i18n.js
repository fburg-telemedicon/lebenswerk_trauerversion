...
const GUEST_CONTRIB = {
  en: {
    ...
    aboutTitle: "What this is about",
    about1: "{name} is having their life story written as a book.",
    about2: "You are invited as someone who knows {name}: the AI will ask you a few questions ABOUT {name}. Just talk freely — the way you would tell a good friend.",
    about3: "Your memories appear in the book as your own contribution, with your name, not as words spoken by {name}. About 10 minutes; you can pause at any time.",
  },
  pl: {
    ...
    aboutTitle: "O co chodzi",
    about1: "{name} właśnie spisuje historię swojego życia w formie książki.",
    about2: "Zaproszono Panią/Pana jako osobę bliską: sztuczna inteligencja zada kilka pytań O {name}. Proszę opowiadać swobodnie — tak, jak opowiada się dobremu przyjacielowi.",
    about3: "Pani/Pana wspomnienia znajdą się w książce jako osobny wkład podpisany Pani/Pana imieniem, a nie jako słowa {name}. Około 10 minut; można przerwać w każdej chwili.",
  },
  es: {
    ...
    about1: "{name} está haciendo que se escriba la historia de su vida en forma de libro.",
    about2: "Le invitamos como persona cercana: la IA le hará algunas preguntas SOBRE {name}. Cuente con libertad, como se lo contaría a una buena amiga.",
    about3: "Sus recuerdos aparecerán en el libro como una aportación propia, con su nombre, y no como palabras de {name}. Unos 10 minutos; puede pausar cuando quiera.",
  },
  it: {
    ...
    about1: "{name} sta facendo scrivere la storia della propria vita sotto forma di libro.",
    about2: "Lei è invitato come persona vicina: l’IA le porrà alcune domande SU {name}. Racconti liberamente, come lo racconterebbe a una cara amica.",
    about3: "I suoi ricordi compariranno nel libro come contributo personale, con il suo nome, e non come parole di {name}. Circa 10 minuti; può interrompere in qualsiasi momento.",
  },
  eu: {
    ...
    aboutTitle: "Zertan den",
    about1: "{name} bere bizitzaren historia liburu gisa idazten ari da.",
    about2: "Hurbileko pertsona gisa gonbidatu zaituzte: adimen artifizialak {name}(r)i BURUZKO galdera batzuk egingo dizkizu. Kontatu askatasunez, lagun min bati kontatuko zeniokeen bezala.",
    about3: "Zure oroitzapenak liburuan zure izenarekin agertuko dira, ekarpen propio gisa, eta ez {name}(r)en hitz gisa. 10 minutu inguru; noiznahi gelditu zaitezke.",
  },
  he: {
    ...
    aboutTitle: "במה מדובר",
    about1: "{name} מעלה כעת את סיפור חייו על הכתב כספר.",
    about2: "הוזמנת כמי שמכיר/ה אותו: הבינה המלאכותית תשאל אותך כמה שאלות עַל {name}. פשוט ספר/י בחופשיות, כפי שהיית מספר/ת לחבר טוב.",
    about3: "הזיכרונות שלך יופיעו בספר כתרומה נפרדת בשמך, ולא כדבריו של {name}. כ-10 דקות; אפשר להפסיק בכל רגע.",
  },
  ar: {
    ...
    aboutTitle: "ما هذا الأمر",
    about1: "يقوم {name} حاليًا بتدوين قصة حياته في كتاب.",
    about2: "لقد دُعيت بصفتك شخصًا قريبًا: سيطرح عليك الذكاء الاصطناعي بعض الأسئلة عَن {name}. تحدّث بحرية، كما لو كنت تروي لصديق عزيز.",
    about3: "ستظهر ذكرياتك في الكتاب كمساهمة مستقلة باسمك، وليست كلامًا على لسان {name}. نحو 10 دقائق، ويمكنك التوقف في أي وقت.",
  },
  fr: {
    ...
    about1: "{name} fait écrire l’histoire de sa vie sous forme de livre.",
    about2: "Vous êtes invité·e en tant que proche : l’IA va vous poser quelques questions SUR {name}. Racontez librement, comme vous le raconteriez à une amie proche.",
    about3: "Vos souvenirs figureront dans le livre comme une contribution personnelle, signée de votre nom, et non comme des paroles de {name}. Environ 10 minutes ; vous pouvez interrompre à tout moment.",
  },
  ro: {
    ...
    aboutTitle: "Despre ce este vorba",
    about1: "{name} își așterne acum povestea vieții într-o carte.",
    about2: "Sunteți invitat ca persoană apropiată: inteligența artificială vă va pune câteva întrebări DESPRE {name}. Povestiți liber, așa cum i-ați povesti unei prietene bune.",
    about3: "Amintirile dumneavoastră vor apărea în carte ca o contribuție proprie, cu numele dumneavoastră, nu ca vorbe ale lui {name}. Aproximativ 10 minute; puteți face o pauză oricând.",
  },
  tr: {
    ...
    aboutTitle: "Konu nedir",
    about1: "{name} şu anda kendi yaşam öyküsünü kitap olarak yazdırıyor.",
    about2: "Yakınlarından biri olarak davet edildiniz: yapay zekâ size {name} HAKKINDA birkaç soru soracak. Rahatça anlatın — yakın bir arkadaşınıza anlatır gibi.",
    about3: "Anılarınız kitapta adınızla birlikte ayrı bir katkı olarak yer alacak, {name} söylemiş gibi değil. Yaklaşık 10 dakika; istediğiniz an ara verebilirsiniz.",
  },
  ru: {
    ...
    aboutTitle: "О чём речь",
    about1: "{name} сейчас записывает историю своей жизни в виде книги.",
    about2: "Вас пригласили как близкого человека: искусственный интеллект задаст вам несколько вопросов О {name}. Рассказывайте свободно — так, как рассказали бы хорошей подруге.",
    about3: "Ваши воспоминания появятся в книге как отдельный вклад с вашим именем, а не как слова {name}. Около 10 минут; прерваться можно в любой момент.",
  },
  uk: {
    ...
    aboutTitle: "Про що йдеться",
    about1: "{name} саме записує історію свого життя у вигляді книги.",
    about2: "Вас запросили як близьку людину: штучний інтелект поставить вам кілька запитань ПРО {name}. Розповідайте вільно — так, як розповіли б добрій подрузі.",
    about3: "Ваші спогади з’являться в книзі як окремий внесок із вашим іменем, а не як слова {name}. Близько 10 хвилин; перерву можна зробити будь-коли.",
  },
}
