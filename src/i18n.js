...
const DE = {
  ...
  relationshipHint: (name) => `Aus Ihrer Sicht: Wer sind Sie für diese Person? Beispiel: Wenn ${name || 'die Person'} Ihre Cousine ist, schreiben Sie „Cousin" (im Sinne von „Ich bin der Cousin von ${name || 'der Person'}").`,
...
const PL = {
  ...
  relationshipHint: (name) => `Z Twojej perspektywy: kim Ty jesteś dla tej osoby? Np. jeśli ${name || 'ta osoba'} jest Twoją kuzynką, wpisz „kuzyn" (w sensie „jestem kuzynem osoby ${name || 'tej osoby'}").`,
...
const EN = {
  ...
  relationshipHint: (name) => `From your perspective: who are you to this person? E.g. if ${name || 'the person'} is your cousin, enter “cousin” (meaning “I am ${name || 'the person'}’s cousin”).`,
