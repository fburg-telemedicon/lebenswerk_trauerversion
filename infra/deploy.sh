...
SECRETS=(
  ...
  # Live-Sprachgespräch (Azure Voice Live, EIGENE Ressource in Sweden Central –
  # die einzige EU-Region mit Voice Live). Leer lassen = Feature aus.
  "azure-voicelive-key=${AZURE_VOICELIVE_KEY:-}"
...
ENVVARS=(
  ...
  "AZURE_VOICELIVE_KEY=secretref:azure-voicelive-key"
  "AZURE_VOICELIVE_ENDPOINT=${AZURE_VOICELIVE_ENDPOINT:-}"
  "AZURE_VOICELIVE_CHAT_MODEL=${AZURE_VOICELIVE_CHAT_MODEL:-gpt-4.1}"
  "ADMIN_USERNAME=${ADMIN_USERNAME:-}"
  "GRAPH_CLIENT_SECRET=secretref:graph-client-secret"
  "GRAPH_TENANT_ID=${GRAPH_TENANT_ID:-}"
  "GRAPH_CLIENT_ID=${GRAPH_CLIENT_ID:-}"
  "GRAPH_MAIL_SENDER=${GRAPH_MAIL_SENDER:-noreply@lebensgeschichten.ai}"
