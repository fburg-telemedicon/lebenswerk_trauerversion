...
const SAVE_FIELDS = new Set(['book_v1', 'book_v2', 'eulogy_text', 'family_tree', 'life_poster', 'care_directive', 'power_of_attorney', 'cv', 'avoca', 'documents', 'job_match', 'history_parallels', 'precaution'])
