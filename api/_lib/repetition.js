...
function repetitionFindings(book, { maxFindings = MAX_FINDINGS, sources } = {}) {
...
function withRepetitionCheck(report, value, sources) {
  let auto = []
...
module.exports = { repetitionFindings, withRepetitionCheck }
